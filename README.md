[**](https://twitter.com/johnlfrench "Twitter")[**](https://www.youtube.com/channel/UCRw0Xezf0iZ-Poas24zZLhw "YouTube")

Game Dev Beginner {.visually-hidden}
=================

[![Game Dev
Beginner](./How%20to%20Queue%20Audio%20Clips%20in%20Unity%20(the%20Ultimate%20Guide%20to%20PlayScheduled)%20-%20Game%20Dev%20Beginner_files/gdb5.png)](https://gamedevbeginner.com/)
[**
Navigation](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#)

-   [Articles](https://gamedevbeginner.com/)
-   [About](https://gamedevbeginner.com/about/)
-   [Newsletter](https://gamedevbeginner.com/newsletter/)
-   [**
    Search](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#)
...
![Unity PlayScheduled feature
image](./How%20to%20Queue%20Audio%20Clips%20in%20Unity%20(the%20Ultimate%20Guide%20to%20PlayScheduled)%20-%20Game%20Dev%20Beginner_files/PlayScheduled-Feature-Image-930x465.jpg)
...
How to Queue Audio Clips in Unity (the Ultimate Guide to PlayScheduled) {.entry-title}
=======================================================================

In
[Unity](https://gamedevbeginner.com/category/unity/ "View all posts in: “Unity”")
by JohnAugust 17, 2018[29
Comments](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comments "Leave a comment on: “How to Queue Audio Clips in Unity (the Ultimate Guide to PlayScheduled)”")

[![Minimal
Orchestral](./How%20to%20Queue%20Audio%20Clips%20in%20Unity%20(the%20Ultimate%20Guide%20to%20PlayScheduled)%20-%20Game%20Dev%20Beginner_files/MINIMAL-Hook-Point-Tests-banner-background-music-for-professionals.jpg)](https://assets.johnleonardfrench.com/minimal/)
...
Do you have a minute to leave me some feedback?
-----------------------------------------------

I hope you enjoyed this article but if you didn’t please let me know
(give it to me straight) and even if you did, I’d love to know what
didn’t work or what I could have done better.

So please leave me a comment and let me know:

-   What I did the worst job of explaining in this article, or…
-   If I missed something that you wanted to know or that you think
...
-   Featured Artwork [Designed by
    Freepik](https://www.freepik.com/free-vector/time-icon-collection_1048123.htm)
-   Audio Wave Artwork [Designed by
    Freepik](https://www.freepik.com/free-vector/halftone-sound-wave-set_973345.htm)

![](./How%20to%20Queue%20Audio%20Clips%20in%20Unity%20(the%20Ultimate%20Guide%20to%20PlayScheduled)%20-%20Game%20Dev%20Beginner_files/jlf-82px.jpg)
...
-   [**
    YouTube](https://www.youtube.com/channel/UC8wTcfcC3JY3pU7_Cn7za6Q?view_as=subscriber)
-   [** johnlfrench](https://www.twitter.com/johnlfrench)
-   [** johnleonardfrench.com](https://johnleonardfrench.com/)

Get Helpful Game Development Tips, Straight to Your inbox
---------------------------------------------------------

Get access to exclusive tips & tricks and master game development basics
the easy way, with deep-dive tutorials and guides.

### Popular Posts

-   [![UI Volume Control
    Graphic](./How%20to%20Queue%20Audio%20Clips%20in%20Unity%20(the%20Ultimate%20Guide%20to%20PlayScheduled)%20-%20Game%20Dev%20Beginner_files/UI-Volume-Control-e1528289432371-300x150.jpg)](https://gamedevbeginner.com/the-right-way-to-make-a-volume-slider-in-unity-using-logarithmic-conversion/)
    [The right way to make a volume slider in Unity (using logarithmic
    conversion)](https://gamedevbeginner.com/the-right-way-to-make-a-volume-slider-in-unity-using-logarithmic-conversion/)
    - A Simple Method for Creating a UI Volume Control in Unity that
    Actually Works: Using a Slider and a Simple Logarithmic Conversion.
-   [![How to make a countdown timer in
    Unity](./How%20to%20Queue%20Audio%20Clips%20in%20Unity%20(the%20Ultimate%20Guide%20to%20PlayScheduled)%20-%20Game%20Dev%20Beginner_files/Countdown-Timer-Feature-300x171.jpg)](https://gamedevbeginner.com/how-to-make-countdown-timer-in-unity-minutes-seconds/)
    [How to make a countdown timer in Unity (in minutes +
    seconds)](https://gamedevbeginner.com/how-to-make-countdown-timer-in-unity-minutes-seconds/)
    - In this step by step guide you'll learn the easy method for making
    a countdown timer in Unity that looks and works as you expect it to.
...
1.  ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)
    ...
    ![](https://secure.gravatar.com/avatar/d4907f45dd7f507a2cee9f0b0a08d8fb?s=120&d=mm&r=g)

    [September 13,
    2018](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-69)
    [Reply
    **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-69)

    Thomas

    Hi John,

    thank you so much for this Guide, that helped me to achieve what I
    wanted after a lot of searching!\
     I needed this not for music, but for a rather short sound effect
    like a thruster with a distinct start sound followed by a loop that
    needed to be at least 2 seconds to sound good. In order to stop
    looping at any point I used the volume property – please let me know
    if that is not a good idea.

    And by the way – your encryption loop sounds great, so thanks for
    that as well! : )

    Here is the code if anyone needs something like that – please feel
    free to cut / change it as you see fit. I made everything public to
    see in the inspector what is going on.
    ...
        public AudioSource thruster\_Start;\
         public AudioSource thruster\_Going\_1;\
         public AudioSource thruster\_Going\_2;
    ...
        void Start ()\
         {\
             startDuration = (double)thruster\_Start.clip.samples /
    thruster\_Start.clip.frequency;\
             goingDuration = (double)thruster\_Going\_1.clip.samples /
    thruster\_Going\_1.clip.frequency;\
         }\
         \
    ...
            bool prepareNextAudio = (AudioSettings.dspTime \>
    nextStartTime – 0.5);
    ...
                        thruster\_Start.PlayScheduled(startTime);\
     ...
                     if (prepareNextAudio)\
                     {\
                         thruster\_Going\_2.PlayScheduled(nextStartTime);\
     ...
                     if (prepareNextAudio)\
                     {\
                         thruster\_Going\_1.PlayScheduled(nextStartTime);\
                         nextStartTime += goingDuration;\
                         state = AudioState.Going1;\
                     }\
                     break;\
    ...
                if (thrusterVolume \< 0)\
                 {\
                     thruster\_Start.Stop();\
                     thruster\_Going\_1.Stop();\
                     thruster\_Going\_2.Stop();
    ...
        void SetAudioSourceVolume(float volume)\
         {\
             thruster\_Start.volume = volume;\
             thruster\_Going\_1.volume = volume;\
             thruster\_Going\_2.volume = volume;\
         }\
     }

    1.  ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)

        ![](https://secure.gravatar.com/avatar/64f090a34cb6702b6f4d132b5f70b87e?s=120&d=mm&r=g)

        Author

        [September 18,
        2018](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-70)
        [Reply
        **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-70)

        John

        That’s great, really glad that this article helped you out.
...
2.  ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)
    ...
    ![](https://secure.gravatar.com/avatar/f90ea8af4ff83b1891261397e0863599?s=120&d=mm&r=g)

    [November 6,
    2018](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-71)
    [Reply
    **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-71)

    sorry

    Just wanted to add that if you are having issues with starting with
    an offset with PlayScheduled you should use AudioClip.timeSamples
    not AudioClip.time.
    ...
    1.  ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)
        ...
        [November 6,
        2018](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-72)
        [Reply
        **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-72)

        John

        Thanks for your comment, please note however that I’m not
        recommending using AudioSource.time, for exactly the reason you
        suggest. It’s a float value and isn’t accurate enough.
        (double)AudioSource.timeSamples / AudioClip.frequency returns an
...
3.  ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)
    ...
    [November 7,
    2018](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-73)
    [Reply
    **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-73)

    sorry

    It’s more then just floating point error .time is in discrete chunks
    and it’s not accurate. Something like “.length” is actually accurate
    it just isn’t as precise as double.\
     To that point unless your dealing with ridiculous huge sample sizes
    you probably won’t see any difference using float over double, or
    just casting “.length” to a double. Anything that represents the
    dspTime has to be double because it deals with huge numbers. Sample
    time is tiny compared to clock time.

    I’m doing lots of sample accurate stuff I found this article
    helpful.\
     I think I’m just adding that if you do ever what to start a
    scheduled clip with an offset you have to use .timeSamples.

4.  ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)

    ![](https://secure.gravatar.com/avatar/fa3ed28913645af213a463ee74752d8d?s=120&d=mm&r=g)

    [October 29,
    2019](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-77)
    [Reply
    **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-77)

    Orestes

    Thank you so much! This guide helped me a lot.\
     I was beginning to think that it was impossible to play a music in
    tempo with another one in Unity after reading so many wrong ways to
    do it. I wondered that was the reason for people using audo
    middleware like FMOD. Now I see it can be done without FMOD. So…
    (I’m a big noob so dont kill me for doing this question) why to use
    FMOD? Is there something you can’t do only with Unity?\
    ...
    1.  ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)
        ...
        [October 29,
        2019](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-78)
        [Reply
        **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-78)

        John

        You’re welcome! There are a lot of things that you can do with
        FMOD, and with Wwise too. Probably more than can be done in
        Unity alone, or at least more easily in some cases. However,
        Unity’s audio engine is (for now) built on top of Fmod, so in
        some ways it’s just a different way of interfacing with the same
        engine. I’d like to do an article in the future on working with
        the different integrators so keep an eye out in the future for
        that.
...
5.  ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)
    ...
    [October 30,
    2019](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-79)
    [Reply
    **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-79)

    Orestes

    OK, I’ll be waiting for that article!\
     Thanks again.\
     Best wishes

6.  ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)

    ![](https://secure.gravatar.com/avatar/dd4912ea3e58228c32a50dc241d8ebf8?s=120&d=mm&r=g)

    [December 22,
    2019](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-92)
    [Reply
    **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-92)

    Eduardo

    Thank you so much for this.

    What I wanted to do was to play some BGM from other videogames,
    where there is an intro and then a loop that plays indefinitely.

    I tried to check the timestamps where the loop occurs in my Audio
    Clip, a beginning and an end. My idea was to play, wait until end,
    then play from the start point (a bit later than 0). The problem in
    the implementation was the use of a coroutine for waiting, so in the
    time that the code was setting the replay it was already too late
    and sounded inaccurately.

    I had given up on the idea by just having the audio for the loop
    part, but I was really missing the intro part. But I found this you
    gave me the solution, by using two AudioSources and by using
    PlayScheduled and SetScheduledEndTime, which I didn’t know about
    before.

    Here is the relevant part of the code, in case anyone finds it
    interesting.

    Note that currentData.iniLoop and currentData.endLoop represent the
    timestamps for the loop of the audio. I obtained them by carefully
    looking at the corresponding clip with Audacity and annotating those
    values.
    ...
    1.  ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)
        ...
        [December 22,
        2019](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-93)
        [Reply
        **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-93)
...
7.  ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)
    ...
    ![](https://secure.gravatar.com/avatar/daa78a26e79315b35b7ef487cfdd213b?s=120&d=mm&r=g)

    [December 29,
    2019](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-95)
    [Reply
    **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-95)

    Dustin

    “Although it is possible to call PlayScheduled at the current DSP
    Time, which will cause the audio to start as soon as possible, one
    of the main benefits of using PlayScheduled is to avoid instantly
    preparing the sound for playback.

    For this reason, to avoid timing errors when scheduling the first
    Clip, I add a slight delay.”

    In the event that you do want an audio clip to play right away and
    then loop infinitely, like turning on a metronome click, would you
    suggest using audiosource.Play() for the initial sound and then use
    your scheduling code loop listed above? Or would it be wiser to
    start calculating your beat right from Start() and then when the
    user turns on the metronome find the next global beat and then use
    playScheduled to schedule the first tick?
    ...
    1.  ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)
        ...
        [January 2,
        2020](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-96)
        [Reply
        **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-96)

        John

        Hi Dustin, it’s probably going to be better to keep it all
        synced using dsp time wherever possible. It is possible to
        schedule a clip immediately, I believe that the risk is that the
        clip may not play at all, or the actual playback will be
        slightly delayed although I have not actually encountered either
        issue before. With that in mind, maybe start with no delay and
        introduce one if you run into issues.

8.  ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)

    ![](https://secure.gravatar.com/avatar/d72b39ace9b25f88eee7e19a4b29961c?s=120&d=mm&r=g)

    [March 20,
    2020](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-291)
    [Reply
    **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-291)

    Preben Thaysen

    Great guide. I found it easy to understand, with all the details
    that I needed, and a nice flow through the guide.\
     Thanks
    ...
    1.  ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)
        ...
        [March 20,
        2020](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-292)
        [Reply
        **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-292)
...
9.  ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)
    ...
    ![](https://secure.gravatar.com/avatar/e3dbfd4ea21d14dc939db9b6ffc3e465?s=120&d=mm&r=g)

    [October 18,
    2020](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-1068)
    [Reply
    **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-1068)
    ...
    1.  ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)
        ...
        [October 19,
        2020](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-1078)
        [Reply
        **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-1078)
...
10. ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)
    ...
    ![](https://secure.gravatar.com/avatar/a719987143bf9fe55f16a162da2c9b38?s=120&d=mm&r=g)

    [October 22,
    2020](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-1100)
    [Reply
    **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-1100)
    ...
    By trying to figure out what was different between that code and the
    other ones in here with arrays, so I tried to just put the
    AudioSources public and everything was solved for me.

    I’m a complete noob at the moment, so I don’t know if it was the
    right call…\
     But it works 🙂
    ...
    1.  ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)
        ...
        [October 26,
        2020](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-1123)
        [Reply
        **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-1123)

        John

        Yeah that would likely have been it. A public Audio Source
        reference is accessible to other Scripts AND it means you can
        access it in the Inspector. You also have the option of keeping
        a variable private but showing it in the inspector with
        SerializeField but setting it as public will work just fine.
        Glad it helped.

11. ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)

    ![](https://secure.gravatar.com/avatar/c5786083a447f6c47eac0cb5e7ce1e24?s=120&d=mm&r=g)

    [December 15,
    2020](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-1444)
    [Reply
    **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-1444)

    Luka

    Hello John,

    thanks for this post. It’s been very helpful. I wanted to take it
    one step further and I synced the playback of the current loop to
    the next one and crossfade the transition, but when I the “play on
    next bar”, the crossfade stats to act weird and I’m not sure what to
    do. Here’s my code. Cheers!
    ...
    public void PlayClipAtNextBar()\
     {\
     // Increase the clip index number, reset if it runs out of clips\
     nextClip = nextClip \< baseClipArray.Length – 1 ? nextClip + 1 :
    0;\
     baseToPlay = baseClipArray[nextClip];

    // This line works out how far you are through the current bar\
     remainder = ((double)baseSourceArray[toggle].timeSamples /
    baseSourceArray[toggle].clip.frequency) % (barDuration);
    ...
    // Load the clip, set volume and playback postion (so it matches the
    current clip's position)\
     baseSourceArray[toggle].clip = baseToPlay;\
    ...
    private IEnumerator StartFade(AudioSource audioSource, float
    duration, float targetVolume)\
     {\
     float currentTime = 0;\
    ...
    while (currentTime \< duration)\
     ...
     audioSource.volume = Mathf.Lerp(start, targetVolume, currentTime /
    duration);\
     yield return null;\
     }
    ...
    1.  ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)
        ...
        [December 17,
        2020](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-1454)
        [Reply
        **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-1454)

        John

        Hi, so there are 3 issues here that I can see:

        ​1. When you start the crossfade, you start it immediately,
        while the music transition waits for the next bar. Pass the
        remainder into the coroutine (cast it as a float) and use Wait
        For Seconds to delay the start of the fade.\
         2. The scheduled end time of the first clip does not account
        for the fade duration (i.e. it stops when the transition
        starts.) To fix it pass in the nextBarTime + the crossfade
        duration.\
         3. When you calculate the start time of the 2nd clip you’re
        using the time position at the point of calculation not when the
        clip is scheduled to start. Either have both layers playing
        constantly, start them at the same time and fade between them
        (this is the more reliable method) or account for the offset by
        using the remainder value (e.g. something like remainder \*
        audioSource.clip.frequency should give you a sample value which
        you can add on to the one that you’re using).
...
12. ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)
    ...
    [December 18,
    2020](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-1476)
    [Reply
    **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-1476)

    Luka

    Hi,

    in the and I’ve managed to make it work, but I forgot to reply here.
    Here’s what I did:
    ...
    // This line works out how far you are through the current bar\
     remainder = ((double)baseSourceArray[toggleBase].timeSamples /
    baseSourceArray[toggleBase].clip.frequency) % (barDuration);

    // This line works out when the next bar will occur\
     nextBarTime = AudioSettings.dspTime + barDuration – remainder;

    // This is for delaying the start of fade in/out (so it starts right
    on the next bar)\
     delay = (float)(barDuration – remainder);

    // Stop the current Clip on the end of 2 bars\
     baseSourceArray[toggleBase].SetScheduledEndTime(nextBarTime +
    barDuration);

    // Start the fade out\
     StartCoroutine(StartFadeOnNextBar(baseSourceArray[toggleBase],
    (float)barDuration, 0f));
    ...
    // Star the clip and fade it in\
     baseSourceArray[toggleBase].PlayScheduled(nextBarTime –
    barDuration);\
     StartCoroutine(StartFadeOnNextBar(baseSourceArray[toggleBase],
    ...
    1.  ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)
        ...
        [December 21,
        2020](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-1545)
        [Reply
        **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-1545)
...
13. ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)
    ...
    ![](https://secure.gravatar.com/avatar/373ee203e9e83516196ca227a9cd3516?s=120&d=mm&r=g)

    [January 25,
    2021](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-1793)
    [Reply
    **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-1793)

    Flo

    Hi John,

    If you want to .Pause a scheduled source but also pause the delay
    value of it, so that when you Unpause the scheduled source, it
    resumes the delay to where it paused. How would you do that ?

    For example :\
     You .PlayScheduled(AudioSettings.dspTime + 2); Lets admit the value
    of AudioSettings.dspTime + 2 on this frame is 98 and the sound will
    play at 100 (98 + 2).\
     Then you wait 1 second and .Pause it. So the dspTime on this frame
    is 99. The dspTime will continue and go beyond “100”. So when you
    will .Unpause it, it will not wait another second before it starts
    playing, but it will play immediatly because we are beyond 100.

    Would the only solution be to record a (double)Value of the
    passedDelay in Update() and reschedule the sound when you .Unpause
    it : .PlayScheduled(AudioSettings.dspTIme + (2 – passedDelay)) ?
    ...
    1.  ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)
        ...
        [January 25,
        2021](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-1797)
        [Reply
        **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-1797)

        John

        If you pause the audio listener, the timing of scheduled clips
        is also paused, even though the DSP time value will appear to
        continue, any scheduled clips are and, as far as I remember this
        extends to any delay you add on also, paused and will then
        operate on different timeline accordingly. Put simply, so long
        as you’re not using an out of time point of reference to
        schedule clips, when you use audioListener.pause, it should just
        work. Let me know if you’re still having issues with it.

14. ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)

    ![](https://secure.gravatar.com/avatar/3461140562aceb18aef019e93b8cc160?s=120&d=mm&r=g)

    [February 10,
    2021](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-2251)
    [Reply
    **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-2251)

    Oriol

    Hi John, great article! It helped me a lot to get a grasp on what
    can be done with music in unity. Now, I’m still unsure I still can
    do what I was looking for. Maybe you have a clue:\
     I have a music loop that I know the bpm and signature, so I know
    exactly when a second music piece will enter, the problem is that
    even if the second AudioClip starts at the right time, I also need
    to stop playing the original loop at that same time :/\
     I can precisely PlaySchedule, but if I stop playing when it’s
    scheduled, i have a gap that cap last up to 1 tab of silence.. Any
    ideas? I have been looking at Unity’s docu but couldn’t find
    anything useful.. thanks before hand! 🙂
    ...
    1.  ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)
        ...
        [February 10,
        2021](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-2254)
        [Reply
        **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-2254)

        John

        Use SetScheduledEndTime and pass in the start time of the next
        clip, then you will be able to stop one clip at the same time as
        staring the other. What I usually do, however, is I don’t set
        the audio sources to loop, instead I just endlessly queue up
        clips to play once. Either the same clip, to create a loop or a
        new clip to change to a different part.
...
15. ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)
    ...
    [February 10,
    2021](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-2253)
    [Reply
    **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-2253)

    Oriol

    “I can precisely PlaySchedule, but if I stop playing when it’s
    scheduled, I have a gap that can last up to 1 bar of silence..”
    (sorry for the typos)

16. ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)

    ![](https://secure.gravatar.com/avatar/21e2e5adc35fae07c0b24f00258c1d60?s=120&d=mm&r=g)

    [February 25,
    2021](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-2622)
    [Reply
    **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-2622)

    Dan Lingman

    Very helpful. I’ve used what you’ve got here to build a DJ for my
    game. Each clip I’ve tripled up – one as a fade in, one as a fade
    out, and one to loop. Asking the dj to swap track (such as when the
    boss battle is about to start) waits for the bar to end, then starts
    fading the current track out and the new one in. Then the main loop
    runs. Thanks!
    ...
    1.  ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)
        ...
        [February 25,
        2021](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-2625)
        [Reply
        **](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#comment-2625)

        John

        You’re welcome! glad it helped.

### Leave a Comment [Cancel reply](https://gamedevbeginner.com/ultimate-guide-to-playscheduled-in-unity/#respond) {#reply-title .comment-reply-title}
...
![game audio
assets](./How%20to%20Queue%20Audio%20Clips%20in%20Unity%20(the%20Ultimate%20Guide%20to%20PlayScheduled)%20-%20Game%20Dev%20Beginner_files/wav-150x150-1.png)

#### Welcome to my blog {.h-widget}

[![John Leonard French -
Photo](./How%20to%20Queue%20Audio%20Clips%20in%20Unity%20(the%20Ultimate%20Guide%20to%20PlayScheduled)%20-%20Game%20Dev%20Beginner_files/jlf-headshot-150x150.jpg)](https://gamedevbeginner.com/about/)

I’m John, a professional game composer and audio designer. I’m also a
keen amateur developer and love learning how to make games. [More about
me](https://gamedevbeginner.com/about/)

#### Latest Posts {.h-widget}

-   [How to get a variable from another script in Unity (the right
    way)](https://gamedevbeginner.com/how-to-get-a-variable-from-another-script-in-unity-the-right-way/)
-   [How to load a new Scene in Unity (with a Loading
    Screen)](https://gamedevbeginner.com/how-to-load-a-new-scene-in-unity-with-a-loading-screen/)
-   [The right way to Lerp in Unity (with
    examples)](https://gamedevbeginner.com/the-right-way-to-lerp-in-unity-with-examples/)
-   [Coroutines in Unity (how and when to use
    them)](https://gamedevbeginner.com/coroutines-in-unity-when-and-how-to-use-them/)
-   [Start vs Awake in
    Unity](https://gamedevbeginner.com/start-vs-awake-in-unity/)

#### Thanks for Your Support {.h-widget}

Some of my posts include affiliate links, meaning I may earn a
commission on purchases you make, at no cost to you, which supports my
blog.

For more information view my [Affiliate
Policy](https://gamedevbeginner.com/affiliate-policy).

[![Game Dev Beginner -
Home](./How%20to%20Queue%20Audio%20Clips%20in%20Unity%20(the%20Ultimate%20Guide%20to%20PlayScheduled)%20-%20Game%20Dev%20Beginner_files/gdb5-300x45.png)](https://gamedevbeginner.com/)
...
-   [Articles](https://gamedevbeginner.com/)
-   [Assets](https://gamedevbeginner.com/assets/)
-   [Newsletter](https://gamedevbeginner.com/newsletter/)

#### Information {.h-widget}

-   [About](https://gamedevbeginner.com/about/)
-   [Privacy Policy](https://gamedevbeginner.com/privacy-policy/)
-   [Comment Policy](https://gamedevbeginner.com/comment-policy/)
-   [Affiliate Policy](https://gamedevbeginner.com/affiliate-policy/)
-   [Contact](https://gamedevbeginner.com/contact/)
